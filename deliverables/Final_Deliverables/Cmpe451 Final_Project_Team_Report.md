...
| Selin Işık | 4 | Frontend | My primary responsibilities involved developing the user interface and overseeing the implementation of all frontend aspects. I organized and planned the workload, ensuring efficient task division among the team, and conducted thorough code reviews to provide guidance and support. At the beginning of the semester, I updated the application's mock-ups and selected an appropriate color theme, while also developing a tailored learning path to streamline our development process. My main contributions were formulating a detailed project plan based on our technology stack and milestones, significantly designing the Poll Card Structure, Feed Page, and Profile Pages, and leading the implementation of Pop-Up Components, ensuring cohesive and functional web application development. |
| Emre Batuhan Göç | 4 | Backend | Throughout the project I was tasked with creating backend API endpoints and maintaining them accoring to our use cases. I maintained poll endpoints for the final milestone. I also was involved in deployment and dockerization of the backend. We used mySql for our database for the core application.  I have overseen the Moderation and Jury part of the project. I also implemented profile and authentication. I was tasked with creating endpoints related to creation, retrieval, and deletion of these sections. I made sure that these endpoints was compliant with the frontend requests. I also created the moderation selection and poll close and grading routine. I also kept swagger up to date. |
